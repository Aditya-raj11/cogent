                ...
                <div class="row gy-3">
                    ...
                    <div class="col-md-6 col-lg-4 d-none" id="url_input">
                        ...
                        <div id="embedded_input" class="d-none">
                            {{ html()->textarea('trailer_url_embedded')
                                ->placeholder(__('placeholder.lbl_embed_code'))
                                ->class('form-control')
                                ->rows(4) }}
                        </div>
                    ...
                    <div class="col-md-6 col-lg-6 d-none" id="video_url_input_section">
                        ...
                        <div id="regular_video_input">
                            {{ html()->text('video_url_input')
                                ->attribute('value', $data->video_url_input)
                        ...
                        <div id="embedded_video_input" class="d-none">
                            {{ html()->textarea('video_url_embedded')
                                ->placeholder(__('placeholder.lbl_embed_code'))
                                ->class('form-control')
                                ->rows(4) }}
                        </div>
                            ...
                            <div class="row gy-3 video-inputs-container">
                                ...
                                <div class="col-md-4 d-none video-embed-input quality_video_embed_input">
                                    ...
                                    {{ html()->textarea('quality_video_embed_input[]')
                                        ...
                                        ->class('form-control')
                                        ->value($mapping->type === 'Embedded' ? $mapping->url : '')
                                        ->rows(4) }}
                                </div>
...
$(document).ready(function() {
    ...
    //     var $newContainer = $('.video-inputs-container:first').clone();
    //     $newContainer.find('input, select, textarea').val('');
    //     $newContainer.find('.select2').select2(); // Reinitialize select2
    //     $('#video-inputs-container-parent').append($newContainer);
    //     handleQualityTypeChange($newContainer);
    // });
});
$(document).ready(function() {
