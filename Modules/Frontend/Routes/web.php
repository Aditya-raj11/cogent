...
use Modules\Frontend\Http\Controllers\ReelFrontendController;
...
Route::get('/reels', [ReelFrontendController::class, 'index'])->name('reels.index');
...
Route::group(['middleware' => ['user']], function () {
    Route::get('/reels/upload', [ReelFrontendController::class, 'create'])->name('reels.create');
    Route::post('/reels/upload', [ReelFrontendController::class, 'store'])->name('reels.store');
