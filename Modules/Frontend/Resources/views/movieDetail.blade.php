...
@else
@include('frontend::components.section.thumbnail',  ['data' => $data['trailer_url'] ,'type'=>$data['trailer_url_type'],'thumbnail_image'=>$data['thumbnail_image'],'watched_time'=>0,'subtitle_info' => $data['subtitle_info'],'dataAccess' => $data['movie_access']])
