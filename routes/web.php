...
use App\Http\Controllers\Backend\ReelManagementController;
...
Route::group(['prefix' => 'app', 'middleware' => ['auth','admin']], function () {
    ...
    */
    Route::group(['as' => 'backend.', 'middleware' => ['auth','admin']], function () {
        ...
        Route::get('reels', [ReelManagementController::class, 'index'])->name('reels.index');
        Route::get('reels/create', [ReelManagementController::class, 'create'])->name('reels.create');
        Route::post('reels', [ReelManagementController::class, 'store'])->name('reels.store');
